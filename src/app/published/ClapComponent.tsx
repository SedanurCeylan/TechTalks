...
const ClapComponent =({storyId, ClapCount, commentId,
UserClaps}:Props) => {
    const [currentClaps, setCurrentClaps] = useState<number>
    (ClapCount)
    const [currentClapByUser, setCurrentClapByUser]=
    ...
    }, [showPopup]); // showPopup bağımlılığı ile
    ...
    return (
        ...
        items-center relative">
            ...
            text-white flex items-center justify-center duration-75
            ease-in ${showPopup ? "scale-100 basis-10 opacity-100 translate-y-0":
